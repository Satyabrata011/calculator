            ...
            <div className="row justify-content-center">
              <div className="col-md-5">
                ...
                <div className="app-header">
                    <span className="app-title"></span>  Simple
                    <span className="badge badge-warning">Calculator <small></small></span> 
                </div>
                ...
                <p className="copy-right text-right">
                 <a href="https://github.com/Satyabrata011" target="_blank">Satyabrata Pradhan </a>
                </p>
            </div>
            </div>
        </div>
